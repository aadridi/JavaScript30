...
/* const bornAfterFift = inventors.filter((person) => person.year < 1600 && person.year > 1499);
console.log(bornAfterFift); */
...
/* console.log(inventors.sort((firstInventor, secondInventor) => firstInventor.year - secondInventor.year)); */

// Array.prototype.reduce()
// 4. How many years did all the inventors live all together?
/* const esperance = inventors.reduce((total, inventors) => total + (inventors.passed - inventors.year), 0);
console.log(esperance);


// 5. Sort the inventors by years lived
const inventorsSorted = inventors.slice().sort((inventorA, inventorB) => (inventorA.passed - inventorA.year) - (inventorB.passed - inventorB.year));
